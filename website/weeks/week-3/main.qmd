...
- [Assignment brief (perform_1.qmd)](perform_1.qmd) - Requirements and submission details
- [Worked example: 2×2 Framework Analysis (perform_2.qmd)](perform_2.qmd) - Complete R-based implementation of network size vs. diversity framework
