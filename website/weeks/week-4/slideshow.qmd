...
## Why Do Networks Look the Way They Look? {.smaller}
...
axes[0].set_aspect('equal')
axes[0].axis('off')
axes[0].set_title('Asymmetric → Mutual', fontsize=11, fontweight='bold')
...
axes[1].set_aspect('equal')
axes[1].axis('off')
axes[1].set_title('Reciprocated Connection', fontsize=11, fontweight='bold')
...
plt.title('Similar nodes cluster together', fontsize=11, fontweight='bold', pad=20)
plt.xlim(-0.5, 4.5)
plt.ylim(-0.5, 1.4)
plt.axis('off')
plt.tight_layout()
...
## Dyadic Process: Homophily vs Selection {.smaller}
...
axes[0].set_aspect('equal')
axes[0].axis('off')
axes[0].set_title('Heterophily', fontsize=11, fontweight='bold')
...
axes[1].set_aspect('equal')
axes[1].axis('off')
axes[1].set_title('Geography', fontsize=11, fontweight='bold')
...
axes[2].set_aspect('equal')
axes[2].axis('off')
axes[2].set_title('Resource Exchange', fontsize=11, fontweight='bold')
...
nx.draw_networkx_labels(g2, pos2, ax=axes[1], font_color='white', font_size=10, font_weight='bold')
axes[1].text(1, -0.3, 'closure pressure', ha='center', va='center',
            fontsize=9, color='#50C878', style='italic')
axes[1].set_xlim(-0.5, 2.5)
...
nx.draw_networkx_labels(g3, pos3, ax=axes[2], font_color='white', font_size=10, font_weight='bold')
axes[2].set_xlim(-0.5, 2.5)
...
axes[0,0].axis('off')
axes[0,0].set_title('003: Empty', fontsize=11, fontweight='bold')
...
axes[0,1].axis('off')
axes[0,1].set_title('012: Single Edge', fontsize=11, fontweight='bold')
...
axes[1,0].axis('off')
axes[1,0].set_title('030T: Transitive', fontsize=11, fontweight='bold')
...
axes[1,1].axis('off')
axes[1,1].set_title('300: Complete', fontsize=11, fontweight='bold')
...
axes[0].text(1, -0.4, 'A dominates all', ha='center', va='center',
            fontsize=9, color='#c41c85', style='italic')
axes[0].set_xlim(-0.5, 2.5)
...
## Permutation Tests for Networks {.smaller}
...
axes[0].set_aspect('equal')
axes[0].axis('off')
axes[0].set_title('Observed Network', fontsize=11, fontweight='bold')
...
axes[1].set_aspect('equal')
axes[1].axis('off')
axes[1].set_title('Random Network 1', fontsize=11, fontweight='bold')
...
axes[2].set_aspect('equal')
axes[2].axis('off')
axes[2].set_title('Random Network 2', fontsize=11, fontweight='bold')
...
- **Procedure**:
  1. Calculate test statistic on observed network
  2. Generate many random networks with same size and density
  3. Calculate test statistic for each random network
  4. Compare observed statistic to distribution of random statistics

**Interpretation**:
- **p < 0.05**: Network structure differs significantly from random
- **p ≥ 0.05**: Cannot reject that network is random
