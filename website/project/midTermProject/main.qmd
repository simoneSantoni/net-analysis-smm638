...
1. Written Report (3,000 words maximum)
  ...
  - Results & Analysis (800 words)
  - Your answer to the case discussion
2. Reproducible Code
...
- **Companion data**: [GitHub repository - data/xoxoday](https://github.com/simoneSantoni/net-analysis-smm638/tree/master/data/xoxoday)
